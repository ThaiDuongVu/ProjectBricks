...
public class GridTrailer : MonoBehaviour
{
    ...
    private void Start()
    {
        StartCoroutine(SpawnDefinedBlock(3, 1, ((int)BlockType.Blue)));
    }
    ...
    private void SwipeBlocks(Vector2 value)
    {
        ...
        trailerProgress++;
        switch (trailerProgress)
        {
            case 1:
                StartCoroutine(SpawnDefinedBlock(2, 2, ((int)BlockType.Blue)));
                break;
